...
import { Heart, Play, Search, Bell, Upload } from "lucide-react"
    ...
    <div className="flex p-6">
      ...
      <div className="flex-1 pr-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center">
            <div>
              <h1 className="text-2xl font-bold">Joss AI</h1>
              <p className="text-sm text-gray-500">(Image to video generator)</p>
            </div>
            {/* Upload Photo Button */}
            <button
              className="ml-6 border border-purple-600 text-purple-600 px-4 py-1.5 rounded-full text-sm font-medium flex items-center gap-1.5"
        ...
        {/* Hero Banner */}
        <div className="relative bg-indigo-900 rounded-xl p-6 mb-8 overflow-hidden">
          {/* Background Image */}
          <Image
      ...
      <div className="w-[300px] flex flex-col gap-6">
        ...
        <div className="bg-purple-600 rounded-xl p-6 text-white">
          ...
          <button className="bg-white text-purple-600 px-4 py-2 rounded-lg font-medium mb-4 w-full">Get Pro Now</button>
